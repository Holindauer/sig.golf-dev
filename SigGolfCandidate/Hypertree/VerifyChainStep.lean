...
theorem chain_step (hash : Hash) (s : MachineState) (level tree step : Nat)
    ...
    ∃ final, Trace hash verify s 49 56 1 1 final ∧ final.pc = 0x14ec ∧
  ...
  obtain ⟨hashed, core, hashedPC, valueOut, ra, sp, frame⟩ := FusedChain.chain_compute verify hash 0x1500 verify_chain_code
