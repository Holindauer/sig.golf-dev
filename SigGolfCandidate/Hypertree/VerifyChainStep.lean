...
theorem chain_step (hash : Hash) (s : MachineState) (level tree step : Nat)
    ...
    ∃ final, Trace hash verify s 64 71 1 1 final ∧ final.pc = 0x14ec ∧
  ...
  obtain ⟨hashed, core, hashedPC, valueOut, ra, sp, frame⟩ := FastHeaderChain.chain_compute verify hash 0x1500 verify_chain_code
