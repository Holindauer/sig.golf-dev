...
### 2026-09-26 complete concrete signer loop and footer

PreludeTree combines upper/bottom tree certificates. PreludeLoopBlocks checks shift/dispatch/advance instruction fetches and reuses prelude_encode_code. PreludeLayerPrepare/PreludeLayer/PreludeLayers certify the entire160level loop on signPrelude, preserving serialized signature fields. Universal bound105766*count cycles; exact loopCalls/loopBlocks counts preserved. PASS2866jobs, permitted-axiom guards pass (siggolf-contract-prelude-layers.log). PreludeFinish certifies final root comparison/termination≤15steps, all memory preserved; PASS2708jobs with axiom guard (siggolf-contract-prelude-finish.log). Organizer files unchanged.

Next executable step: create PreludeLoadedLoopData importing PreludeLoadedPrepared, PreludePrefixRefine, PreludeLayers. From actual three-input initialState obtain prepared state; transfer secret/message bytes using aligned low-word frame and pk bytes via bytes_of_answer_words. Apply resumed entry_full; compose traces≤100659instructions106038cycles741calls765blocks. Construct LoopData atlevel0 including zeroCURRENT and secret/pk words, frame preserved by OutsidePrefix. Then combine sign_layers160 and sign_footer_executes into full execution/resource and functional certificates; update candidate image/certificate only after complete proof.

### 2026-09-26 official-loader to full loop invariants

PreludeLoadedPrefix composes actual three-input loader, derived public key, cleanup, and resumed prefix. It proves≤100659instructions106038cycles741calls765compressions, PC1220, exact reference index/randomizer, zeroLEVEL/CURRENT, stack, secret words, and derived public-key words, for arbitrary cache. Digest byte extraction is proven from two64-bit words; input bytes use aligned low-word preservation, excluding derived pk addresses. PASS2872jobs with guard. PreludeLoadedLoopData constructs full LoopData atlevel0 with zeroextended160-bit index and all memory invariants; PASS2890jobs with guard. Logs siggolf-contract-loaded-prefix.log and siggolf-contract-loaded-loop-data.log. Organizer files unchanged.

Next: adapt SignExecution into PreludeExecution importing PreludeLoadedLoopData and PreludeFinish (do not import stale SignExecutionSetup). Take actual loaded state as hypothesis initially. Set pk=Reference.keygen hash secretKey; root match follows from root/pk word equalities without digest_eq_of_words. Compose pre+sign_layers160+footer:118247calls121769compressions; conservative instruction bound16167394, cycle bound17028613. Then add initialState existence for preludeSubmission and full signer functional/resource certificates before candidate image switch/export/submission.

### 2026-09-26 complete official signer execution and output

PreludeExecution proves universal successful execution from every official three-input loaded state, including arbitrary caches:≤16167394instructions17028613cycles, exactly118247hash calls121769compressions, all reference signature fields. Derived pk makes final root check universally successful. PASS2893jobs with permitted-axiom guard. PreludeRun proves loaded-state existence from sign_valid, exact official runWith output equal to reference compact wire signature, and universal termination/resource bound121769≤BUDGET_SIGN. PASS2898jobs, both guards pass. Logs siggolf-contract-prelude-execution.log and siggolf-contract-prelude-run.log. Organizer files unchanged; no submission yet.

Next: assemble parallel PreludeCandidateHonest/Fields for preludeSubmission. Reuse unchanged keygen/expand/verify via definitional phase equality; use PreludeRun for sign3input. Update obsolete honest constants from actual proven keygen/expand runs, sign118247/121769 and charged verifier bound1731313. CandidateHonest/Fields currently import stale SignRun and assert old numbers; do not import these into new assembly. Prove preludeSubmission admissible and phase equivalences; preserve original Images.sign to avoid invalidating legacy component proofs. Security transfer must target preludeSubmission while preserving official contract. Then full certificate/export/policy/reference tests.

### 2026-09-26 candidate phase assembly

PreludeCandidatePhases proves preludeSubmission admissible, unchanged keygen/expand/verify runWith equalities, and exact expansion output/cost89733cycles. PASS2967jobs, admission axiom propext only, expansion permitted axioms guard passes.

Direct honest pipeline proof elaborated but failed kernel deep-recursion at8192 after44seconds; it is NOT a validated theorem. Saved attempt separately at research/PreludeCandidateHonest.pending.lean, excluded from candidate modules. Do not increase recursion/rely on this result: introduce an abstract pipeline with witness-charge parameter to keep kernel conversion away from bytecode, prove generic pipeline_success, then prove honest_eq_pipeline matching current three-input sign and added witnessCycles. Old KeygenOrganizer.honest_eq_pipeline is stale and must not be imported as-is. Next use this bridge with PreludeCandidatePhases, PreludeRun, VerifyCharged to derive honest_exact≤1731313, keygen761/sign121769/expand0 budget costs. Then certificate fields/security transfer.

### 2026-09-26 honest pipeline and nonsecurity certificate fields

Resolved kernel recursion using PreludePipeline: abstract pipeline parameterized by witness-loading charge, generic success theorem, exact bridge from current three-input Submission.honest. Both bridge guards use only propext/Quot.sound. PreludeCandidateHonest now proves all-message deterministic success with charged verification≤1731313, keygen761/sign121769/expand0 compression costs; PASS2969jobs. PreludeOrganizerBridges ports generic fixed-oracle/support/completeness/moment arguments without stale old-pipeline imports. PreludeCandidateFields proves actual admissibility, universal termination, completeness, exponential compression bounds, verification bound, and conditional certificate_of_secure. PASS2973jobs, all guards pass. Logs charged-pipeline/prelude-fields. Security is still an explicit unproved premise; no complete certificate/submission.

Next security audit: SecurityBytecodeReference imports obsolete CandidateHonest and Signing.sign_run_refines with pk input, expand85221. SecurityBytecodeCounts.calls_signCompact still111596 (old152level), must prove160level117508. Actual signer118247 adds739keygen calls; cannot substitute equal-count claim. Adapt reference signing game to derive pk (or prove conservative budget inequality), update request3input semantics and correct count coupling; preserve actual budget/security guarantees. Follow SecurityBytecodeReference→Interaction→Experiment→Adapter→ActualCutoff→MonitorRealTransfer before assembling full certificate for preludeSubmission.

### 2026-09-26 exact derived-key signing security accounting

Corrected SecurityBytecodeCounts.calls_signCompact from obsolete111596 to160level117508; existing symbolic proof verifies this exact count. PreludeSecuritySign defines signDerived as reference keygen followed by reference signCompact and proves exact reference output and118247queries. signing_view matches actual official three-input bytecode value/count for arbitrary caches. signing_overhead proves same signature as existing game under validKey, with exact+739queries; signing_budget_domination proves the old per-request charge is a lower bound. PASS2923jobs with permitted-axiom guards; siggolf-contract-security-derived-sign.log. This is per-request evidence only, not full security.

Next route: avoid globally changing ideal/reference games. Introduce charged reference Interface with old referenceSign output and count+739; fixed-hash equivalence to actual signer follows from signing_overhead. Port generic contextual interaction coupling from SecurityBytecodeInteraction (requires avoiding stale SecurityBytecodeReference imports), then prove charged-reference winning event≤uncharged reference winning event under same budget. Transcripts preserve signed history/signingRequests and track hashCalls charged=base+739*successful requests. Existing interact_equivalent_generic requires exact counts, so it cannot directly compare charged/uncharged interfaces. Full adaptive budget domination remains required before using MonitorRealTransfer.real_bound.

### 2026-09-26 actual security interface and generic adaptive coupling

PreludeSecurityInterface defines charged referenceSign using the existing monadic signCompact with explicit+739 count overhead, actualInterface selecting preludeSubmission, exact fixed-oracle signing equivalence under validKey, and actual_interact/actual_experiment equal to organizer security semantics. This is not a claim of full reference experiment equivalence. PASS2934jobs with guards. Ported generic adaptive interaction coupling into PreludeSecurityCoupling, independent of stale SecurityBytecodeReference imports; PASS2935jobs with guard. Logs siggolf-contract-security-interface.log and siggolf-contract-security-coupling.log. Lifted map proof required explicit map_eq_bind_pure_comp/liftComp_bind/liftComp_pure normalization.

Next: define referenceKeygen/referenceCheck/referenceInterface in PreludeSecurity (copy pure definitions from SecurityBytecodeReference; referenceSign already charged). Prove keygen/check equivalence using PreludeCandidatePhases and current VerifyFunctional/KeygenVerifyCountRun. Port generic experiment coupling from SecurityBytecodeExperiment using new coupling; establish actual→charged-reference distribution. Then separate charged-vs-base adaptive budget domination (same histories, count+739*requests), required before MonitorRealTransfer bound. Do not equate charged reference with old experiment without this inequality.

### 2026-09-26 full actual-to-charged-reference experiment coupling

PreludeSecurityReference completes charged referenceInterface, exact keygen equivalence and both signature/witness forgery-check equivalences. Reuses current verifier query accounting and exact expansion89733. PreludeSecurityExperiment proves exact shared-random-oracle distribution equality between preludeSubmission.securityExperiment and experimentWith charged referenceInterface, including adaptive requests/private coins/arbitrary caches/lifetime/counts. PASS3013jobs with permitted-axiom guards (siggolf-contract-security-experiment.log; initial reference log also passes). Security still requires charged→base event domination and connection to existing monitor bound.

Next: define baseReferenceInterface identical to referenceInterface but signing count omits739. Prove charge monotonicity across adaptive interactions: adversary receives identical values, transcript signed/signingRequests unchanged, hashCalls differs by nonnegative739 per signing request; referenceCheck preserves won and adds common verifier cost. Need full distribution/event inequality, not only fixed-hash counts. Candidate approach joint interaction producing paired AttackResults under same oracle/private coins, prove left/right marginals and invariant(left.won=right.won,right.hashCalls≤left.hashCalls), then probEvent monotonicity. Port remaining reference-to-ideal adapter against baseReferenceInterface without stale CandidateHonest imports; only then apply MonitorRealTransfer.real_bound.

### 2026-09-26 joint adaptive budget accounting

PreludeBudgetAccounting defines baseReferenceInterface, explicit transcript/result count shifts, signing_charge, record_charge and check_charge preserving forgery verdicts while adding overhead. interactTracked is generic in Interface and runs shared queries while accumulating739per accepted signing request separately. tracked_base proves its first marginal exactly equals ordinary base interaction. PASS3014jobs with guards (tracked_base only propext/Quot.sound; check_charge permitted axioms). Initial concrete-interface induction caused200kheartbeat timeout through implicit reduction; making tracker generic fixes it.

Next prove tracked_charged: mapping (r,extra)↦addResultCalls r extra over interactTracked baseReferenceInterface adversary sk pk rounds state transcript extra equals interactWith referenceInterface from addTranscriptCalls transcript extra. Induct rounds, use check_charge for submit, signing_charge plus record_charge for sign, arithmetic for public hash, shared coins/step. Then lift both marginals through observe/experiment, use pointwise won equality and baseCount≤chargedCount to prove winning-budget probability inequality. Continue base reference-to-ideal adapter afterward.

### 2026-09-26 02:07 UTC — charged tracker marginal
Proved `PreludeSecurity.tracked_charged_generic` and instantiated `tracked_charged`: the tracked base interaction maps exactly to the charged interaction, including adaptive signing, refusal at lifetime, direct hash queries, both forgery checks and shared private coins. Together with `tracked_base` these provide both exact marginals. Lean build PASS3014jobs; instantiated theorem guard permits only propext/Classical.choice/Quot.sound. Organizer files unchanged. No submission: security probability domination and base-reference monitor adapter still outstanding.
Next: lift both marginals through a joint secret-keyed experiment/observe, then prove won-and-budget event domination from nonnegative accumulated overhead. Preserve accepted PR12 and its exact SHA.

### 2026-09-26 02:12 UTC — full budget probability domination
Added PreludeBudgetExperiment: both tracker marginals lifted through key generation and shared random-oracle observation, then proved `charged_probability_le_base` and `actual_probability_le_base` for every adversary, round count and budget. Winning with the actual charged count implies winning under the reference count because accumulated overhead is nonnegative. PASS3015jobs and permitted-axiom guards; no sample bounds or organizer changes. This closes the repeated-key-derivation budget discrepancy conservatively.
Next: port SecurityBytecodeAdapter into a PreludeSecurity base-reference adapter (avoid stale SecurityBytecodeExperiment import), connect baseReferenceInterface to SecurityExperiment.realExperiment, and then restore monitor/security bound. No new submission until complete certificate/export validation.

### 2026-09-26 02:17 UTC — complete current-contract certificate
PreludeReferenceAdapter proves baseReferenceInterface equals the counted reference game. Isolated PreludeReferenceCutoff/PreludeMonitorWinBound/PreludeMonitorRealTransfer avoid obsolete actual-bytecode imports. Corrected remaining structural signer charges from152level constants to160levels:117508total,117507non-index,117501upper,117506afterindex. Atomic shape and dependent monitor proofs revalidated. PreludeCertificate now proves actual universal security and complete Certificate preludeSubmission1731313. PASS3125jobs, final security/certificate guards only propext/Classical.choice/Quot.sound; organizer files unchanged. No official submission yet.
Next: export a standalone Solution.lean for preludeSubmission, compile it under pinned current organizer contract, run source-policy/exact bundle/protected-definition and relevant bytecode/reference tests, refresh beta rules/upstream before publishing. Preserve accepted PR12 SHA; current candidate S=W119632,C1731313 (different contract from incumbent).

### 2026-09-26 02:22 UTC — exported current-contract candidate validated
Created research/contract-certified-submission with exact411-helper dependency closure plus Solution.lean/claim.json. Exported sizes/layout/certificate compile; exported certificate axiom guard passes. Policy passes415entries2672029bytes; SHA256 manifest saved. Exact four certified images match independent tested bytecode (572/847/15/578words). Reference/sign/expand/verify and corruption rejection tests pass. SHA256 sample: signer118247calls121769compressions; verify1280367execution+468witness=1280835cycles, only a sample; universal C1731313 comes from certificate. Score207120436816,S=W119632.
Fetched upstream beta c6b246292a3ae43403e236f65fea39db00ee1502: protected SigGolf files and dependency pins exactly match; README change only clarifies salted-message heuristic. Current submission rules require layout and layout_offsets; export includes both. No remote publication yet. Accepted PR12 remains fixed under old7c2d18e contract. Current-contract candidate is a migration (raw score above old-contract incumbent); inspect publication handling across contract versions before choosing the next submission. Reproducible export/check scripts and logs saved under research/.

### 2026-09-26 02:27 UTC — current-contract submission and next route
Publication compares scores within each contract SHA (service/github.py). Current official contract be68468 has prior score672119612832; validated score207120436816 improves it. Pushed dev proof checkpoint c8fb86c to Holindauer/sig.golf-dev beta. Closed own already-published PR12 before reusing submissions beta, preserving its accepted e04ef8d SHA. Submitted exact validated export at a7fa95385b85c8cbb24c990c25f1f3b80c2c95bc as PR21; official be68468 verdict PENDING. Do not modify that submitted SHA or advance incumbent without matching published record.
Independent research continued: ported eight persistent-step-base modules from checkpoint91adbc2; replaced old hash-length384bits by48bytes. Unchanged proofs then pass2772jobs under current contract, including StepBaseLoop (17*n+36 nonempty,5 empty). First old-ABI proof timed out; corrected byte-length constant resolves it. Next integrate step-base verifier image in research checkout and propagate generic loop into concrete VerifyChainLoop/cost bounds before full certificate/export checks; pending PR21 stays fixed.

### 2026-09-26 02:32 UTC — concrete persistent-step-base integration
PR21 remains PENDING, exact a7fa953 head unchanged and no published record. Research verifier now retains x28=STEP through preparation/HASH/finish, removing two instructions per chain hash. Only verifier image words changed; all four image lengths and signer prelude remain fixed. Concrete VerifyChainLoop and VerifyLeafLoop PASS2783jobs, including universal17*n+36 chain bound and8916-cycle all-chain leaf loop. Moved new concrete step-base code assertions to VerifyChainLoop to avoid a circular dependency through ChainData.
Independent exact-image reference/rejection tests PASS: sample verify1227293execution+468witness=1227761cycles,26858calls28608compressions. Total current-contract C1633369 (score195403200208) is propagated but not yet fully certificate-validated; do not submit based on this sample. Next run lake build SigGolfCandidate.Hypertree.PreludeCertificate to validate all changed upper-tree/layer/resource/security dependencies, then regenerate separate export and run all export/policy/axiom checks. Preserve pending PR21 and existing validated export.

### 2026-09-26 02:39 UTC — step-base certificate complete; header-register prototype
Full PreludeCertificate PASS3129jobs atC1633369,S=W119632,score195403200208. Fixed two integration omissions: exact-call loop used old counterOverhead and VerifyLayerTree retained old10836 upper bound; now stepBaseOverhead and10220. Export research/contract-step-base-submission compiles with guarded permitted axioms; policy419entries2705347bytes,415helpers; exact417-file manifest saved. Protected organizer and dependencies unchanged. Prior exact-image reference/rejection tests pass. Ready candidate held while PR21 remains pending; submitted SHA unchanged and no official record recognized.
Independent next route implemented/tested in research/register-header-current-probe: retain first hash-header word in x14 and eliminate recurrent load. Reference/rejection tests pass at1207757samplechargedcycles (20004 below step-base sample). Required invariant/proof plan in research/register-header-current-notes.md; projected16*n+37 nonempty chain and1591711 totalC are planning only. Next prove initial x14 header equality, HASH/finish/check preservation, and recurrent update before integrating new image. On PR21 acceptance+matching records, promote it and submit ready step-base bundle after fresh rule/contract checks.

### 2026-09-26 02:44 UTC — register-header recurrent proof
PR21 still PENDING; no exact published record. Added RegisterHeader and RegisterHeaderBlocks: exact recurrent machine-state equivalence to step-base preparation except updatedx14; four-instruction OrdinarySteps certificate; Ready(x14=header) preservation through preparation, HASH, finish and check. PASS2761jobs with permitted-axiom guards. Ready step-base export remains unchanged.
Initial register-header prefix/tail definitions added, but direct whole-state initial equivalence simplification exceeded kernel recursion8192. Rejected that proof; draft saved only in research/RegisterHeader.initial.pending.lean, not imported or exported. Next split initial prefix into common four copy instructions, header-building chunk, and common six index-copy instructions; prove chunk state relation then compose tail (which overwritesx10). Do not retry monolithic unfolding. Then certify31instruction initial setup and thread Ready through16cycle recurrent loop. New image is still only separate prototype; no certificate/submission claimed.

### 2026-09-26 02:50 UTC — initial cached-header state relation
PR21 still pending, no matching official record. RegisterHeaderChunks now proves generic shadow-register seed/add-field/store/copy relations and composes initial_chunks: new31instruction setup equals previous initial state exceptx14 holding constructed header. Also stored_header proves header memory agrees with saved register. PASS2760jobs with initial_chunks/header_shadow permitted-axiom guards. Splitting index copy into two-instruction copyField lemmas resolved kernel depth failure from a six-instruction monolithic index proof.
Direct initial_ready composition still produced oversized elaboration/kernel terms; stopped revised attempt and saved research/RegisterHeaderChunks.ready.pending.lean. It is not imported and has no claimed validation. Next prove generic suffix Ready lemma on abstract input state, then apply it to header(copyValue s), rather than rewriting initial_chunks inside an expanded31instruction state. Proceed to initial OrdinarySteps block and16cycle recurrent core. Fully validated held step-base export and pending PR21 remain unchanged.

### 2026-09-26 03:00 UTC — official publication, next submission, header invariant
Official records published PR21 exact a7fa95385b85c8cbb24c990c25f1f3b80c2c95bc under be68468c347b0aeb887b1900abcf4214e76c1951, S=W119632,C1731313,score207120436816. Saved record ID a7fa95385b85c8cbb24c990c25f1f3b80c2c95bc:be68468c347b and advanced incumbent. Closed completed PR21 before submitting fully validated step-base export as PR22 exact2c9376c8580a8c709b1642cc93ff742c27e9ea8d, S=W119632,C1633369,score195403200208. Dev proof a8f4cb4e57434633149f853bbe5d8eaee5136f24; PR22 official validation pending. Preserve both exact submitted heads.
Independent RegisterHeaderReady.initial_ready now proves the cached x14 header equals memory after all31initial instructions. Abstract suffix, memory and register accessor lemmas avoid nested-state kernel recursion. PASS2761jobs; axiom guard only propext/Quot.sound; log research/validation/siggolf-register-header-ready.log. This is a component proof, not a complete improved certificate.
Next executable research step: derive the31instruction initial OrdinarySteps block from StepBaseBlocks.initial_block, replacing header accumulator x10 by x14 to match RegisterHeader.initial and the separate prototype. Then adapt StepBaseCore/InitialData/Steps/Loop with Ready invariant and recurrent4instruction preparation. Prove16*n+37 bound before any image integration or new certificate. Check PR22 verdict/exact official record first each wake and prioritize any rejection.

### 2026-09-26 03:08 UTC — cached-header execution/data proofs
PR22 exact2c9376c8580a8c709b1642cc93ff742c27e9ea8d remains officially PENDING under be68468; absent from live records. Submitted head unchanged.
RegisterHeaderInitialBlock proves31initial instructions for the x14 accumulator (PASS2762jobs). RegisterHeaderCore preserves RegisterHeader.Ready through HASH and finish (PASS2762jobs). RegisterHeaderData.recurrent proves8instructions/15cycles including prepare+HASH+finish and all buffered data/frame invariants (PASS2771jobs). RegisterHeaderInitialData.compute proves35instructions/42cycles and cached-header readiness after first hash (PASS2775jobs). All theorem axiom guards pass with permitted axioms; protected organizer/dependencies unchanged. Logs siggolf-register-header-{initial-block,core,data,initial-data}.log. An omitted getReg_setReg_ne prevented the recurrent x28 framing proof; added the accessor lemma and reran successfully. Initial guard whitespace normalized; no proof bypass.
Next: port StepBaseSteps to RegisterHeaderSteps, add Ready input/output and check_ready preservation for recurrent branch; recurrent trace9instructions/16cycles, initial38instructions/45cycles unchanged. Then port StepBaseLoop with Ready inductive invariant and derive nonempty16*n+37,empty5. Keep independent image prototype and pending PR22 unchanged until universal certificate integration/export is complete.

### 2026-09-26 03:13 UTC — universal cached-header loop and candidate integration
PR22 exact2c9376c8580a8c709b1642cc93ff742c27e9ea8d remains officially PENDING; absent from live records snapshot /private/tmp/siggolf-records-0313.json (list key submissions).
RegisterHeaderSteps and RegisterHeaderLoop PASS2777jobs with permitted-axiom guards. Universal loop now costs16*n+37cycles for nonempty chains,5empty; exact instruction count9*n+37. Added cached-header Ready invariant across the recurrent check/induction.
Integrated x14 verifier image (578words) and reproducible generator in independent research checkout. Propagated leaf8654, upper leaf9364, layer10005, universal execution1591243 and charged1591711 candidate bounds. Full PreludeCertificate rebuild started, log research/validation/siggolf-register-header-certificate.log, exec session4097; not yet complete or certified. Exact four-image/reference/rejection tests PASS, log siggolf-register-header-integrated-reference.log: sample verify1207289execution+468=1207757charged,26858hashcalls28608compressions. Sample is not the universal certificate. Organizer/dependency files unchanged.
Next: poll session4097 or inspect build log/process; repair any full-certificate failures and finish all guards. After full PASS export to a NEW research/contract-register-header-submission directory using a copied export_step_base.py with bound1591711 and new output path; never overwrite pending step-base bundle. Compile exported Solution/axioms, policy and exact manifest checks; recheck beta rules and PR22 publication before submitting. Pending PR22 head must stay fixed.

### 2026-09-26 03:18 UTC — complete cached-header certificate/export
PR22 remains PENDING, exact SHA absent from official submissions snapshot0318. Full cached-header build exposed one stale intermediate loaded_recovery cycle bound1632886; reduced it to1591228 using the already-proven layer bound. Full PreludeCertificate now PASS3134jobs; universal charged C1591711, S=W119632,score190419570352. Final security/certificate permitted-axiom guards pass.
New isolated export research/contract-register-header-submission contains420helper modules plus Solution.lean/claim.json. Exported Solution compilation and certificate axiom guard PASS. Policy PASS424entries2737427bytes; exact422file SHA256 manifest saved (every helper matches tested source). Relevant exact-image reference/rejection tests passed previous wake; protected organizer files/dependencies remain unchanged. Logs siggolf-register-header-certificate-final.log, -export.log, -export-axioms.log, -policy.json, -manifest.json. Ready locally, NOT submitted or officially validated. Keep pending step-base bundle and PR22 exact SHA fixed.
Next: inspect PR22 exact verdict/publication and repair any rejection. If published, advance incumbent and refresh upstream beta/rules before publishing this ready cached-header candidate. If pending, start separate compression feasibility research: inspect Signature.lean Compact/serialization and expand budget, identify recoverable fields with universal reconstruction and security preservation; do not assume random digest bytes compress. Keep ready header image/export unchanged while prototyping.
