...
The four RISC-V images have a complete Lean certificate: `SigGolfCandidate.Hypertree.Candidate.certificate : SigGolf.Certificate submission 5617759`, in [Certificate.lean](../../SigGolfCandidate/Hypertree/Certificate.lean).

| Parameter | Value |
| --- | ---: |
| Signature bytes S | 119,632 |
| Witness bytes W | 119,632 |
| Maximum honest verification cycles C | 5,617,759 |
| Score S × C | 672,063,744,688 |
...
| Verification | 5,617,759 | ≤ 51,841 | ≤ 53,602 |
...
The bottom layer is bounded separately: 116 cycles for its leaf, 236 for its tree, and 288 for the full layer including dispatch. The complete bound is `145 + 288 + 159 * 35329 + 15 = 5617759` cycles.
